...
* 피드백 공유: 적절한 저장소에 GitHub 문제를 만들어 제품 또는 설명서에서 버그를 보고하고, 개선 사항을 요청하고, 새 기능을 요청합니다. 문제를 제출하는 데 사용할 저장소를 모르시겠습니까? 이 경우 문제가 적절히 라우팅되도록 [Asset Compute SDK 저장소](https://github.com/adobe/asset-compute-sdk)에 기록하십시오.
