...
1. [!DNL Adobe Developer App Builder]에 대한 [액세스 및 자격 증명을 획득](https://developer.adobe.com/app-builder/docs/get_started/app_builder_get_started/first-app#acquire-access-and-credentials)합니다.
