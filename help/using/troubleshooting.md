...
* `/register` 또는 `/process` 요청 오류를 방지하려면 필요한 모든 API-Asset Compute, Adobe [!DNL I/O Events], Events Management 및 Runtime-이 Adobe [!DNL `I/O Project`] 및 Workspace에 포함되어 있는지 확인하십시오.
